...
const projectEn = [
    {
        title: 'Bookie: Homepage of a Travel Agency (OpenClassrooms Project)',
    ...
    {
        title: 'Kasa: Housing Rental App with React (OpenClassrooms Project)',
    ...
    {
        title: 'Sophie Bluel: Dynamic Website (OpenClassrooms Project)',
